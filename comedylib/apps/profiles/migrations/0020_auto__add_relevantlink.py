...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RelevantLink'
        db.create_table('profiles_relevantlink', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('collection', self.gf('django.db.models.fields.related.ForeignKey')(related_name='relevant_links', to=orm['content.Collection'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200)),
            ('order', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('profiles', ['RelevantLink'])


    def backwards(self, orm):
        # Deleting model 'RelevantLink'
        db.delete_table('profiles_relevantlink')
    ...
    models = {
        ...
        'profiles.relevantlink': {
            'Meta': {'object_name': 'RelevantLink'},
            'collection': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'relevant_links'", 'to': "orm['content.Collection']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
