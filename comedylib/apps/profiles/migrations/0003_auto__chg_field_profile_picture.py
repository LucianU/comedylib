...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('profiles_profile', 'picture', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Profile.picture'
        db.alter_column('profiles_profile', 'picture', self.gf('django.db.models.fields.files.ImageField')(default='picture', max_length=100))
