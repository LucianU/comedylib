...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('profiles_feeling', (
        ...
        db.send_create_signal('profiles', ['Feeling'])

        # Removing M2M table for field dislikes on 'Profile'
        db.delete_table('profiles_profile_dislikes')
    ...
    def backwards(self, orm):
        ...
        db.delete_table('profiles_feeling')

        # Adding M2M table for field dislikes on 'Profile'
        db.create_table('profiles_profile_dislikes', (
        ...
        db.create_unique('profiles_profile_dislikes', ['profile_id', 'video_id'])
