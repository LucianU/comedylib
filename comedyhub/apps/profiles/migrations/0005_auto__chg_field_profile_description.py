...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('profiles_profile', 'description', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Profile.description'
        db.alter_column('profiles_profile', 'description', self.gf('django.db.models.fields.TextField')(default='none'))
